...
class M_fsn extends CI_Model{
	...
	// 	function obat(){
	// 		$q2 = $this->db->query("SELECT * FROM obat order by id asc");
	// 		if($q2->num_rows()>0){
	...
	function getAvgStaypcs(){
		$q6 = $this->db->query("SELECT * from avgstay join obat on obat.id = avgstay.id_obat  where obat.type = 'Botol' or obat.type = 'cair' or obat.type = 'Larutan' order by avgstay.cumavgstay desc");
	...
	function getAvgCrpcs(){
		$q7 = $this->db->query("SELECT * from consumsition  join obat on obat.id = consumsition.id_obat  where obat.type = 'Botol' or obat.type = 'cair' or obat.type = 'Larutan' order by consumsition.consumtionrt desc");
		...
		function AvgStaypcs(){
		$q8 = $this->db->query("SELECT * from avgstay join obat on obat.id = avgstay.id_obat  where obat.type = 'Botol' or obat.type = 'cair' or obat.type = 'Larutan' order by  avgstay.id_obat asc");
	...
	function AvgCrpcs(){
		$q9 = $this->db->query("SELECT * from consumsition join obat on obat.id = consumsition.id_obat  where obat.type = 'Botol' or obat.type = 'cair' or obat.type = 'Larutan'  order by consumsition.id_obat asc");
		...
		function getAvgStaylbr(){
		$q6 = $this->db->query("SELECT * from avgstay join obat on obat.id = avgstay.id_obat where obat.type = 'Tablet' or obat.type = 'Capsul' or obat.type = 'Pil'  order by avgstay.cumavgstay desc");
	...
	function getAvgCrlbr(){
		$q7 = $this->db->query("SELECT * from consumsition join obat on obat.id = consumsition.id_obat where obat.type = 'Tablet' or obat.type = 'Capsul' or obat.type = 'Pil'   order by consumsition.consumtionrt desc");
		...
		function AvgStaylbr(){
		$q8 = $this->db->query("SELECT * from avgstay join obat on obat.id = avgstay.id_obat where obat.type = 'Tablet' or obat.type = 'Capsul' or obat.type = 'Pil'  order by  avgstay.id_obat asc");
	...
	function AvgCrlbr(){
		$q9 = $this->db->query("SELECT * from consumsition  join obat on obat.id = consumsition.id_obat where obat.type = 'Tablet' or obat.type = 'Capsul' or obat.type = 'Pil' order by consumsition.id_obat asc");
