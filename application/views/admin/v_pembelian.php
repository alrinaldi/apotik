...
?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
     ...
     <form action="<?php echo base_url().'admin/pembelian/pembelian_filter'?>" method='post'>
...
<?php
echo $week1=date('Y-m-d', strtotime("-1 week"));
...
?><div class="form-group">
       ...
       <div class="panel panel-primary">
                    <div class="panel-heading">Laporan pembelian
                                            ...
                                            <a class ="btn btn-primary btn-flat" href="<?php echo base_url('admin/penjualan/export_excel')?>">EXPORT to EXCEL</a><?php }else{
                        }?>
                    <br>
                    <div class="panel-body">
